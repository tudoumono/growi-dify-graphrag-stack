...
[Phase 3] 運用品質を上げる
  ...
  G: directory 一括取り込みサブコマンド
       ↓ F, G が確定してスペックを書いてから実装

[Phase 4] パイプライン連携（将来検討）
  H: tmp/files の前処理済みデータを GraphRAG に流す設計
```
...
1. Section 6 の Q1〜Q3 を確認・決定する
2. Phase 1 の各改修についてスペック（仕様書）を書く
3. スペックのレビュー後、実装に入る
